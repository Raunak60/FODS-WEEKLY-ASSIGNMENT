...
def main():
    ...
    # Example of creating another student with predefined values
    print("\nCreating another student with predefined values:")
    another_student = Student("S12345", "Jane Doe", "123 College St", 2023, "Sophomore", "B")
    another_student.display_details()
